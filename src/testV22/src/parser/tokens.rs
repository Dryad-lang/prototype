    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::LxGt => write!(
                f,
                "{}",
                format!(token_dbg_str!(), "COMPARISON GREATER THAN")
            ),
            ...
            Self::LxMultSet => write!(
                f,
                "{}",
                format!(token_dbg_str!(), "MULTIPLICATION ASSIGNMENT")
            ),
            ...
            Self::LxLShiftSet => {
                write!(f, "{}", format!(token_dbg_str!(), "LEFT SHIFT ASSIGNMENT"))
            }
            Self::LxRShiftSet => {
                write!(f, "{}", format!(token_dbg_str!(), "RIGHT SHIFT ASSIGNMENT"))
            }
